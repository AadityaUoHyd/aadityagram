...
const Post = ({ post }) => {
    ...
    const [isBookmarked, setIsBookmarked] = useState(false); // Initial state for bookmark status
    ...
    return (
        <div className='my-8 w-full max-w-sm mx-auto'>
            ...
            <div className='flex items-center justify-between my-2'>
                ...
                <div onClick={bookmarkHandler} className="cursor-pointer hover:text-gray-500">
                    <Bookmark  style={{ fill: isBookmarked ? 'black' : 'none' }} />
                </div>
